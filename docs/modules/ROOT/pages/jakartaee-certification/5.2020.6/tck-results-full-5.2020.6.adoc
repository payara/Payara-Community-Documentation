...
**Payara Server 5.2020.6 Full Profile Certification Summary**
...
+
https://docs.payara.fish/community/docs/5.2020.6/jakartaee-certification/5.2020.6/tck-results-full-5.2020.6.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 657.577 s - in TestSuite
[INFO] 
[INFO] Results:
[INFO] 
...
```
 [mvn.test] [INFO] Tests run: 1805, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,818.265 s - in TestSuite
 [mvn.test] [INFO] 
