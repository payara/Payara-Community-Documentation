...
**Payara Server 5.2022.2 Web Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 5.2022.2 (Web Profile)]
|===
...
+
https://docs.payara.fish/enterprise/docs/5.2022.2/jakartaee-certification/5.2022.2/tck-results-web-5.2022.2.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 797.146 s - in TestSuite
[INFO]
[INFO] Results:
[INFO]
...
```
 [mvn.test] [INFO] Tests run: 1655, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,514.074 s - in TestSuite
 [mvn.test] [INFO]
