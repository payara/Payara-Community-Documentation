...
**Payara Server 5.2021.2 Full Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 5.2021.1]
|===
...
+
https://docs.payara.fish/community/docs/5.2021.1/jakartaee-certification/5.2021.1/tck-results-full-5.2021.1.html
...
```
   [INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 662.288 s - in TestSuite
   [INFO] 
   [INFO] Results:
   [INFO] 
...
```
   [mvn.test] [INFO] Tests run: 1805, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,671.069 s - in TestSuite
   [mvn.test] [INFO] 
...
```
    ...
    [junit] Tests run: 50, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.073 sec
```
### ejb 
