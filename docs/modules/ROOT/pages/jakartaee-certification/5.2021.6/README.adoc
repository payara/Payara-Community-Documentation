...
The following distributions of Payara 5.2021.6 are certified:

* xref:jakartaee-certification/5.2021.6/tck-results-full-5.2021.6.adoc[Payara Server 5.2021.6 - Full profile]
