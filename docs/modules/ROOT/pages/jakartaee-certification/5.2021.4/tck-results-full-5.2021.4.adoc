...
**Payara Server 5.2021.4 Full Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 5.2021.4]
|===
...
+
https://docs.payara.fish/community/docs/5.2021.4/jakartaee-certification/5.2021.4/tck-results-full-5.2021.4.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 656.306 s - in TestSuite
[INFO] 
[INFO] Results:
[INFO] 
...
```
   [mvn.test] [INFO] Tests run: 1805, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,703.452 s - in TestSuite
   [mvn.test] [INFO] 
