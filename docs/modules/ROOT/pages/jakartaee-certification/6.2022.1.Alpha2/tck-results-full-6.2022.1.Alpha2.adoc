...
{empty} +
{empty} +
https://search.maven.org/artifact/fish.payara.distributions/payara/6.2022.1.Alpha2/zip[Payara Server 6.2022.1.Alpha2]
|===
...
+
https://docs.payara.fish/community/docs/6.2022.1.Alpha2/jakartaee-certification/6.2022.1.Alpha2/tck-results-full-6.2022.1.Alpha2.html
