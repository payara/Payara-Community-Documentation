...
**Payara Server 5.2021.10 Full Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 5.2021.10]
|===
...
+
https://docs.payara.fish/community/docs/5.2021.10/jakartaee-certification/5.2021.10/tck-results-full-5.2021.10.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 696.212 s - in TestSuite
[INFO]
[INFO] Results:
[INFO]
...
```
 [mvn.test] [INFO] Tests run: 1805, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 2,083.956 s - in TestSuite
 [mvn.test] [INFO]
