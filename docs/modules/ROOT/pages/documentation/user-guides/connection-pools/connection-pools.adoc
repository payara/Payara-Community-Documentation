...
image:/images/connection-pools/connection_pools_1.jpg[New JDBC Connection Pool]
...
image:/images/connection-pools/connection_pools_2.png[Connection pool properties]
