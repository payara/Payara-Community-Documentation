...
local and remote instances of Payara Server Community. The plugin makes use of the REST
...
represents a Java EE server. As Payara Server Community is derived from GlassFish,
...
To deploy your application to Payara Server Community using the Maven Cargo Plugin, the
