...
==== Instance Name
_Since Payara Server 5.2021.8_

For the purpose of attributes specific to the running instance, Payara provides placeholder `${instance}`. It is replaced with the name of the current instance:
```
    <metadata>
