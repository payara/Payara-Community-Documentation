...
* CDI 1.2
* JSON-P 1.0
* {mpConfigSpecUrl}[Config {mpConfigVersion}]
* {mpMetricsSpecUrl}[Metrics {mpMetricsVersion}]
* {mpHealthSpecUrl}[Health Check{mpHealthVersion}]
* {mpFaultToleranceSpecUrl}[Fault Tolerance {mpFaultToleranceVersion}]
* {mpJwtSpecUrl}[JWT Authentication {mpJwtVersion}]
