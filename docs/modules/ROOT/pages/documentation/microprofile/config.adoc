...
WARNING: The (secrets) directory config source is released in *_technical preview_*. It's fully usable and supported but it's subject to change in future versions. Read more in xref:/general-info/technical-preview.adoc[Features in Technical Preview].
