...
The OpenAPI can be configured through the xref:documentation/microprofile/config.adoc[Config API]. For example, these configuration properties can be put in the `microprofile-config.properties`.
