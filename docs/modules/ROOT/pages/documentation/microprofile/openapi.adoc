...
For example, in the case where an application wishes to represent Java `Date`s in epoch milliseconds, the following configuration could be used (line escapes and indentation added for readability):
