...
image::netbeans-plugin/netbeans-plugin-configure-server.png[Server Configuration Window]
...
image::netbeans-plugin/netbeans-services.png[NetBeans Services]
...
image::netbeans-plugin/netbeans-project-run-configuration.png[Project Run Configuration]
