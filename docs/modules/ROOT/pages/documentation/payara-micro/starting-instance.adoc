...
link:/documentation/payara-micro/maven/maven.adoc[Maven Support] for
...
link:/documentation/payara-micro/configuring/config-program.adoc[Configuring an Instance Programmatically]
