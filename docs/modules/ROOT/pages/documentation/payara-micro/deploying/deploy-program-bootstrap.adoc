...
command line option (described in the section xref:documentation/payara-micro/deploying/deploy-cmd-line.adoc#deploying-multiple-applications[Deploying From the Command Line]),
