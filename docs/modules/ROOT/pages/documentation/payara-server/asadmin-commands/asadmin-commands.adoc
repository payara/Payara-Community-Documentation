...
- xref:documentation/payara-server/server-management-commands.adoc[Server Management Commands]
- xref:documentation/payara-server/misc-commands.adoc[Miscellaneous Commands]
