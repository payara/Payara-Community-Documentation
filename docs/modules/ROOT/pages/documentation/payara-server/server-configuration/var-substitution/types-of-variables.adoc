...
MicroProfile properties need to be declared in one of the Payara defined xref:/documentation/microprofile/config/README.adoc#config-sources[config sources].
