...
on xref:documentation/payara-server/server-configuration/http/protocols.adoc[protocols].
...
For more information on creating protocols, see xref:documentation/payara-server/server-configuration/http/protocols.adoc[protocols]. The parameters are all explained
