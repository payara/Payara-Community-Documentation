...
xref:documentation/payara-service/notification-service/notification-service.adoc[Notification service] into the internal Payara event bus based on Hazelcast distributed topics.
