...
link:/documentation/payara-server/logging/logging.adoc[the logging page].
...
found on the link:/documentation/payara-server/notification-service/notification-service.adoc[notification service page].
