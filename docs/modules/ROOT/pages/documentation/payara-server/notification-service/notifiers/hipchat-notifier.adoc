...
Payara Server Community has now included functionality to send notifications from
the
...
Server Community involves just one step. In the Admin Console, simply add the room
