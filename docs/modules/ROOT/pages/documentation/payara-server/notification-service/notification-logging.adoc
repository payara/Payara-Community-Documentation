...
xref:general-info/technical-preview.adoc[Features in Technical Preview].
...
* xref:documentation/payara-server/notification-service/notification-logging.adoc#enabling-or-disabling-logging-to-a-file[Enabling or Disabling Logging to a File]
* xref:documentation/payara-server/notification-service/notification-logging.adoc#configuring-log-file-rotation[Configuring Log File Rotation]
** xref:documentation/payara-server/notification-service/notification-logging.adoc#rotation-on-date-change[Rotation on Date Change]
** xref:documentation/payara-server/notification-service/notification-logging.adoc#rotation-on-file-size[Rotation on File Size]
** xref:documentation/payara-server/notification-service/notification-logging.adoc#rotation-on-time-limit[Rotation on Time Limit]
* xref:documentation/payara-server/notification-service/notification-logging.adoc#to-set-maximum-number-of-history-files[To Set Maximum Number of History Files]
* xref:documentation/payara-server/notification-service/notification-logging.adoc#to-change-the-name-and-location-of-the-log-file[To Change the Name and Location of the Log File]
* xref:documentation/payara-server/notification-service/notification-logging.adoc#to-set-compress-on-rotation[To Set Compress on Rotation]
...
image:notification-service/logging/payara_notification_log_to_file.png[Log to File enabled]
...
image:notification-service/logging/payara_notification_rotation_on_date_change.png[Rotation on Date Change enabled]
...
image:notification-service/logging/payara_notification_rotation_on_file_size.png[File Rotation Limit]
...
image:notification-service/logging/payara_notification_rotation_on_time_limit.png[File Roatation Time Limit]
...
image:notification-service/logging/payara_notification_set_maximum_number_of_history_files.png[Maximum History File]
...
image:notification-service/logging/payara_notification_change_name_and_location_of_log_file.png[Log File]
...
image:notification-service/logging/payara_notification_set_compress_on_rotation.png[Compress on Rotation enabled]
