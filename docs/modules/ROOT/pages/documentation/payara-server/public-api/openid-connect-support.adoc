...
[[microsof-adfs-userinfo-integration]]
=== Microsof ADFS UserInfo integration

For on-premise ADFS (Active Directory Federation Services) the following property was added to get user information from the ID Token.
