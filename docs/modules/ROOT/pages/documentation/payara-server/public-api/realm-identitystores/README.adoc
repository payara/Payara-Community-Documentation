...
- xref:realm-identity-store-definition.adoc[@RealmIdentityStoreDefinition]
- xref:file-identity-store-definition.adoc[@FileIdentityStoreDefinition]
- xref:certificate-identity-store-definition.adoc[@CertificateIdentityStoreDefinition]
- xref:pam-identity-store-definition.adoc[@PamIdentityStoreDefinition]
- xref:solaris-identity-store-definition.adoc[@SolarisIdentityStoreDefinition]