...
Subcommands From a File_ section. The guide can be found in the _GlassFish Server {glassfishVersion} 
Open Source Edition Documentation_ referenced in the xref:/documentation/payara-server/README.adoc[Payara Server Documentation Overview]
