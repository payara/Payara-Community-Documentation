...
+
image::hazelcast/hazelcast-select-hazelcast.png[Hazelcast Selection in Payara Server]
...
image::hazelcast/hazelcast-admin-console-hazelcast-options.png[Hazelcast Options]
