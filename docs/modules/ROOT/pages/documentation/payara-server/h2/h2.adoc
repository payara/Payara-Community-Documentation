...
H2 is a Java-based Database which replaced Derby as the default database in Payara 5. Derby itself as a database that can be started by Payara Server Community, is removed in version 5.201.
