...
This mode also provides xref:cdi-probe/README.adoc[CDI Probe], which allows to inspect and monitor CDI beans of deployed applications at runtime.
...
- xref:enabling-cdi-dev-web-desc.adoc[web.xml Application Descriptor]
- xref:enabling-cdi-dev-console.adoc[Administration Console]
- xref:enabling-cdi-dev-asadmin.adoc[Asadmin deploy command]