...
See xref:concurrent-instances.adoc[Controlling Stateless EJB Concurrent Instances] for detailed information.
...
See xref:ejb-jar-names.adoc[Overwriting EJB JAR Archive Names] for detailed information.
...
See xref:lite-remote-ejb.adoc[Lite Remote EJB Communication] for detailed information.
...
See xref:persistent-timers.adoc[Persistent EJB Timers on the Domain Data Grid] for detailed information.
