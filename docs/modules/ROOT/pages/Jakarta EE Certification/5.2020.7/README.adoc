...
The following distributions of Payara 5.2020.7 are certified:

* xref:jakartaee-certification/5.2020.7/tck-results-full-5.2020.7.adoc[Payara Server 5.2020.7 - Full profile]
