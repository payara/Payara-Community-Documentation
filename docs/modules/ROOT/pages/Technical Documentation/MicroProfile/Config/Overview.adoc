...
xref:Technical Documentation/Payara Server Documentation/Server Configuration And Management/var-substitution/types-of-variables.adoc[Types of Variables]
...
In addition to the standard configuration properties, Payara Server Community and Micro Community provide a number of out-of-the-box config properties
