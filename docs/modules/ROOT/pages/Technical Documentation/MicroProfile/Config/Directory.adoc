...
xref:/Technical Documentation/Payara Micro Documentation/asadmin/pre-and-post-boot-scripts.adoc[Pre- and Postboot scripts].
See xref:Technical Documentation/Ecosystem/docker-server-usage.adoc#_environment_variables[Payara Server container image env vars]
