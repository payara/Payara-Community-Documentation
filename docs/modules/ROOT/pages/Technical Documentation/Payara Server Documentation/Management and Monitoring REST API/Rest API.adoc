...
|Type |Name
|*basic*
|*xref:/Technical Documentation/Payara Server Documentation/Management and Monitoring REST API/security.adoc#simple_auth[simple_auth]*
|*apiKey*
|*xref:/Technical Documentation/Payara Server Documentation/Management and Monitoring REST API/security.adoc#token_cookie[token_cookie]*
|=======================================================================
...
|Type |Name
|*basic*
|*xref:/Technical Documentation/Payara Server Documentation/Management and Monitoring REST API/security.adoc#simple-auth[simple_auth]*
|*apiKey*
|*xref:/Technical Documentation/Payara Server Documentation/Management and Monitoring REST API/security.adoc#token_cookie[token_cookie]*
|=======================================================================
