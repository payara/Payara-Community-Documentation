...
auto-naming is an _asadmin_ feature added to help with the naming of instances,
...
NOTE: There are some circumstances in which specifying the `--autoname` or `-a` option _after_ the command name will result
