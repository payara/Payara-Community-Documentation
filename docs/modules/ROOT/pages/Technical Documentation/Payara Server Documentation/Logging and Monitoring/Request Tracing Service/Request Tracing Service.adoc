...
Alternatively you can view a short summary xref:Technical Documentation/Payara Server Documentation/Request Tracing Service-service/terminology.adoc[here].
