...
This argument cannot be used when instance is started via xref:/Technical Documentation/Payara Micro Documentation/starting-instance.adoc[root directory launcher]. 
