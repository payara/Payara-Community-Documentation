...
When using xref:/Technical Documentation/Payara Micro Documentation/Payara Micro Configuration and Management/Micro Management/Jar Structure and Configuration/rootdir.adoc[persistent root configuration directory], it is possible to generate a launcher bound to that directory using the command:
...
xref://Technical Documentation/Payara Micro Documentation/configuring/config-program.adoc[Configuring an Instance Programmatically]
