...
xref:/Technical Documentation/Payara Server Documentation/Public API/cdi-events.adoc[remote CDI events]
...
xref://Technical Documentation/Payara Micro Documentation/appendices/operation-methods.adoc#cdi-methods[appendices].
