...
Micro Community instances. `PayaraMicro.class` methods are used during the bootstrap
...
Deployment methods are used for the deployment of applications to Payara Micro Community
instances.
...
These methods are required for setting up and cleaning Payara Micro Community instances.
...
These methods are used for getting information on running Payara Micro Community instances.
