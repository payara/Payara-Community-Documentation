...
Payara Micro will start in "clustering" mode by booting up the xref://Technical Documentation/Payara Micro Documentation/clustering/clustering.adoc[Data Grid], allowing other instances reachable in the network to join the grid automatically. 
