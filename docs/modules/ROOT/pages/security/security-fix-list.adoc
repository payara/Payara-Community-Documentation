...
|https://nvd.nist.gov/vuln/detail/CVE-2021-42392[CVE-2021-42392] | N/A | N/A | Unauthenticated RCE in H2 Database Console |  |  | Unrelated to Payara Server. H2 Database Console doesn't launch the H2 Database Console and doesn't make it available in any way.
