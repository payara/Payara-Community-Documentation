...
The generation of the Official Docker Images is also integrated in the main Payara repository. In order to be able to built these images, a Docker Client needs to be installed on the machine you execute the Maven command. 
