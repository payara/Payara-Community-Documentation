...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 740.864 s - in TestSuite
[INFO] 
[INFO] Results:
[INFO] 
...
```
 [mvn.test] Tests run: 1805, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,831.183 s - in TestSuite
 [mvn.test] [INFO] 
...
```
    ...
    [junit] Tests run: 50, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.082 sec
```
### ejb 
