...
# Payara Server 5.194 Full Profile Certification Summary

- Product Name, Version and download URL (if applicable):
+
https://payara.fish/download[Payara Server 5.194]
...
+
http://download.eclipse.org/jakartaee/platform/8/eclipse-jakartaeetck-8.0.1.zip[Jakarta EE Platform CTS 8.0.1]
, SHA-256: `3026f2b2fc7a2f1e802aed6cf1671d486dc90d1b03fd3519367577aa9f6545fa`

- Public URL of TCK Results Summary:
+
http://docs.payara.fish/v/master/jakartaee-certification/5.194/tck-results-full-5.194.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 656.717 s - in TestSuite
[INFO] 
[INFO] Results:
[INFO] 
...
```
 [mvn.test] [INFO] Tests run: 1805, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,685.694 s - in TestSuite
 [mvn.test] [INFO] 
