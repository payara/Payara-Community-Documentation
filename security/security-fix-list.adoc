...
[cols="<,<,<,<,<,<",options="header",]
|=======================================================================
|Detected By |Status |Summary | Release |Pull Requests |Observations
| https://www.owasp.org/index.php/Clickjacking_Defense_Cheat_Sheet[OWASP] |FIXED | Web administration console is vulnerable against clickjacking/UI redress attacks. | 4.1.2.174 | https://github.com/payara/Payara/pull/2097[#2097] |
|=======================================================================
