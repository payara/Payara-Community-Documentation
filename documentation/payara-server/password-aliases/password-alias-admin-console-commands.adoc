...
+
image::/images/password-aliases/password-aliases-new.png[Create new password alias]

. On the next page, enter the name of the alias, and the password, twice:
+
image::/images/password-aliases/password-aliases-creation.png[Password alias creation]

. Finally, press the *OK* button to create your new alias:
+
image::/images/password-aliases/password-aliases-created.png[Password alias created]
...
image::/images/password-aliases/password-aliases-modifying.png[Modifying password alias]
...
image::/images/password-aliases/password-aliases-deleting.png[Deleting password alias]
