...
the
link:/documentation/payara-server/jmx-monitoring-service/jmx-monitoring-service.adoc[JMX Monitoring Service], the link:/documentation/payara-server/health-check-service/health-check-service.adoc[HealthCheck service] or the
