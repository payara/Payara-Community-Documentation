...
image:/images/notification-service/logging/payara_notification_rotation_on_time_limit.pngFile Roatation Time Limit]
...
[source, shell]
----
asadmin> set-log-attributes fish.payara.enterprise.server.logging.compressOnRotation.file=true
----