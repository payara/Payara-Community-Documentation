...
* link:/documentation/payara-server/notification-service/notification-logging.adoc#enabling-or-disabling-logging-to-a-file[Enabling or Disabling Logging to a File]
* link:/documentation/payara-server/notification-service/notification-logging.adoc#configuring-log-file-rotation[Configuring Log File Rotation]
** link:/documentation/payara-server/notification-service/notification-logging.adoc#rotation-on-date-change[Rotation on Date Change]
** link:/documentation/payara-server/notification-service/notification-logging.adoc#rotation-on-file-size[Rotation on File Size]
** link:/documentation/payara-server/notification-service/notification-logging.adoc#rotation-on-time-limit[Rotation on Time Limit]
* link:/documentation/payara-server/notification-service/notification-logging.adoc#to-set-maximum-number-of-history-files[To Set Maximum Number of History Files]
* link:/documentation/payara-server/notification-service/notification-logging.adoc#to-change-the-name-and-location-of-the-log-file[To Change the Name and Location of the Log File]
* link:/documentation/payara-server/notification-service/notification-logging.adoc#to-set-compress-on-rotation[To Set Compress on Rotation]
