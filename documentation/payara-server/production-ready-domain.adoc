...
has not been modified in any way for Payara Server. The default domain is not
however designed to be run in production, but instead to be a usable example for
