...
the _GlassFish Server {{ book.glassfishVersion }} Open Source Edition Documentation_ 
referenced in the link:/documentation/payara-server/README.adoc[Payara Server Documentation Overview]
