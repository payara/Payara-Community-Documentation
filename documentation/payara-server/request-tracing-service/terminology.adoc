...
A Span Tag is simply a key:value pair of information that is added to a Span to provide details about the unit fo work.
...
to a Span about an event happening at a specific time during the duration fo the Span (e.g. an error).