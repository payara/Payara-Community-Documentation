...
The realm identity stores are initialized by specifying any of the following annotation in a valid place as defined by the https://jakarta.ee/specifications/security/1.0/apidocs/[Jakarta EE Security API].
