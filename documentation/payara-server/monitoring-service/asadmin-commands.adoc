...
You can use the verbose mode to see which levels were restarted:
...
Verbose mode will show you which modules were affected and what monitoring level they are set to.
