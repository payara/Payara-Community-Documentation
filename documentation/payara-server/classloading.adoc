...
In order to make the server to use the bundled JSF implementation within the application, you need to set an additional configuration parameter, class loading delegation alone is not enough.
