...
image::/images/protocols/left-bar-location.png[Configuration Page Location]
...
with a `+` at the start of each. E.g. `+TLS_RSA_WITH_AES_256_CBC_SHA,+SSL_RSA_WITH_3DES_EDE_CBC_SHA`.
