...
Also if you would decide to use more ids to filter out group names from a distinguished name,
there may be conflicts - you can have a state UK and also organisational unit UK. All parsed groups are equal.
...
See also link:https://javaee.github.io/tutorial/security-intro005.html[Java EE Tutorial: Working with Realms, Users, Groups, and Roles]
