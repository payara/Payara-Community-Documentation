...
image:/images/jmx-monitoring-service/jmx-monitoring-page-jmx-enabled.png[JMX Monitoring Page, with JMX enabled]

To enable AMX (recommended), go to General monitoring page and select `AMX Enabled`:

image:/images/jmx-monitoring-service/jmx-monitoring-page-amx-enabled.png[JMX Monitoring Page, with JMX enabled]

NOTE: In versions prior to _Payara Server 4.1.2.182 or 5.182_, `AMX Enabled` options was in JMX Monitoring page.
...
image:/images/jmx-monitoring-service/jmx-add-attribute.png[Add JMX Property]

NOTE: In versions prior to Payara Server 4.2.182 or 5.182, the --addproperty 
