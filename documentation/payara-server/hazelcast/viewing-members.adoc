...
Since 5.191, a "Last Heartbeat" field will also be shown, displaying the date and time that the DAS last received a
hearbeat pulse from a Payara Server or Payara Micro instance. This heartbeat should refresh every 5 seconds.
