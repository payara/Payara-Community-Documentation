...
|Data Grid Discovery Mode | See link:documentation/payara-server/hazelcast/discovery.adoc[Discovery Modes]
...
|Enabled | See link:documentation/payara-server/hazelcast/enable-hazelcast.adoc[Disabling Data Grid] for detailed information
...
|`--clustermode`|Cluster Mode|Can be one of `domain`, `tcpip` or `multicast`. See link:documentation/payara-server/hazelcast/discovery.adoc[Discovery Modes] for
