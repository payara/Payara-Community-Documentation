...
* Docker Image - The Docker image to use. This must be specified; the suggested image name is the Payara provided image:
_payara/payaraserver-node:{{book.currentVersion}}_.
