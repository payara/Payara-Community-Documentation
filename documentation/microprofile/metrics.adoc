...
JMX Mbeans can be exposed as ***Custom Vendor Metrics*** can be defined by the user by supplying a custom https://github.com/payara/Payara/blob/f30de88abca76111caadf0d57249d77d53b067e7/appserver/payara-appserver-modules/microprofile/metrics/src/main/resources/metrics.xml[metrics.xml] file in the `$PAYARA_HOME/glassfish/domains/$DOMAIN_NAME/config/` folder with the following format:
