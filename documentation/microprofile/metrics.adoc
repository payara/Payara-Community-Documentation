...
|`virtualservers`
|If defined, the '/metrics' endpoint assigned to the specified virtual servers, Otherwise endpoint assigned to all virtual servers. The virtual server list must be specified as a comma separated string of values.
|-
|No
|===
