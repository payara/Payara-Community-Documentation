...
See the full https://github.com/eclipse/microprofile-rest-client/blob/master/spec/src/main/asciidoc/providers.asciidoc#provider-declaration[MicroProfile documentation] for the registration methods.
