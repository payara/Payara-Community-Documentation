...
*Aim*::
Sets the directory to be used for the secrets directory config source.
...
|`directory`
|Full path to the directory containing secrets files
|-
|yes
...
*Aim*::
Gets the value of the directory to be used for the secrets directory config source.
