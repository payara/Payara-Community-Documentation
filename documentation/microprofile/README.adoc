...
* JSON-P 1.0
* Java Servlets 3.1
* http://microprofile.io/project/eclipse/microprofile-fault-tolerance[Fault Tolerance 1.0]
* http://microprofile.io/project/eclipse/microprofile-health[Health 1.0]
* http://microprofile.io/project/eclipse/microprofile-jwt-auth[Json Web Token 1.0]
* http://microprofile.io/project/eclipse/microprofile-metrics[Metrics 1.0]
* http://microprofile.io/project/eclipse/microprofile-config[Config 1.1]
