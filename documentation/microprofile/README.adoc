...
MicroProfile is a specification provided as a Bill Of Materials (BOM) which can
be used by developers as a generic dependency which many vendors can implement.

The aim of the specification is to provide a set of APIs which are focused on 
microservices
