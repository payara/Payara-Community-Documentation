...
There is a link:https://github.com/payara/ecosystem-netbeans-plugin[NetBeans IDE plugin]
built specifically for Payara Micro to create and manage the application actions
 (build / run / reload / debug / profile / stop).
