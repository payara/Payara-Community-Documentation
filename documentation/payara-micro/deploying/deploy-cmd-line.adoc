...
Alternativly the context root can be included in the argument to the `--deploy` option. It follows the path to the war file seperated by `File.pathSeparator`:
