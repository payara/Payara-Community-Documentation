...
Amazon SQS (Simple Queue Service) is a hosted a highly scalable distributed
message queue.

In order to connect to Amazon SQS, the `AmazonSQSRAR-0.1.0-SNAPSHOT.rar` has to
be deployed as shown in the link:cloud-connectors.adoc#Installing-a-connector[
