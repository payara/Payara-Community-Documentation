...
image::/images/netbeans-plugin/payara-server/netbeans-plugin-hot-deploy.png[Enable Hot Deploy]

Also, make sure to enable the *Compile on Save* and *Deploy on Save* option from the *Properties* panel of the Project.

image::/images/netbeans-plugin/payara-server/netbeans-project-compile-on-save.png[Compile on Save]
image::/images/netbeans-plugin/payara-server/netbeans-project-deploy-on-save.png[Deploy on Save]
