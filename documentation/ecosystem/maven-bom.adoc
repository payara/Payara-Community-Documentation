...
Payara's Bill Of Material (BOM) artifact collects all of these version for following types of artifacts:
...
Arquillian is recomended way for integration tests with the server.
