...
The plugin requires JDK 7 or higher and the latest version is currently
`1.0.0-SNAPSHOT`
...
==== `start`
*Aim*: This goal starts Payara Micro with the specified configuration. By
default this goal is attached to the payara-micro phase.
...
|commandLineOptions
|_none_
|Defines a lists of command line options that will be passed onto payara-micro.
...
immediately kill the executing Payara Micro instance. This goal is attached to
the `payara-micro` phase.
