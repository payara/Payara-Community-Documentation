...
The `bundle` goal always search for domain configuration files in `src/main/resources` to copy in to the `MICRO-INF/domain` directory of the created uber jar. 
