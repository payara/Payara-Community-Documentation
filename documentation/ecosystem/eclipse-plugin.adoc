...
+
image::/images/eclipse-plugin/install-marketplace.png[Eclipse Marketplace]
...
+
image::/images/eclipse-plugin/install-security-warning.png[Security Warning]
...
+
image::/images/eclipse-plugin/new-server-menu.png[New Server menu]
2. Select *Payara -> Payara* and set the *Host name* and some comprehensible *Server name*.
+
image::/images/eclipse-plugin/new-server-window.png[New Server window]
3. Then click *Next* to another window with server runtime configuration.
+
image::/images/eclipse-plugin/new-server-runtime.png[New Server Runtime]
...
+
image::/images/eclipse-plugin/new-server-instance.png[New Server Instance]
...
+
image::/images/eclipse-plugin/new-server-resources.png[New Server Resources]

[[adding-resources]]
== Adding Resources to Server

1. First import or create some project, deployable to the *Payara Server*.
  Here we use one of the link:https://github.com/javaee-samples/javaee7-samples[Java EE 7 Samples] .
2. Right click the target server in the *Servers* view and click *Add and Remove...*
+
image::/images/eclipse-plugin/add-resource-menu.png[Add and Remove menu]
3. Select resources you want to be managed by the *Payara Tools*, add them to the right panel and click *Finish*.
+
image::/images/eclipse-plugin/add-resource-window.png[Add and Remove window]
4. Now you can watch the deployment of the application in the *Console* view.
+
image::/images/eclipse-plugin/add-resource-console.png[Add and Remove window]
...
+
image::/images/eclipse-plugin/add-resource-browser.png[Request and Response in Browser]
...
+
image::/images/eclipse-plugin/add-resource-admin.png[Admin Console]
...
+
image::/images/eclipse-plugin/reconfig-overview.png[Server Overview]
...
+
image::/images/eclipse-plugin/reconfig-runtime.png[Runtime Configuration]
