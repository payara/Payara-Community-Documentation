...
*Aim*::
Enables or disables the HealthCheck Service. The command updates
...
NOTE: In order to get notifications from the HealthCheck Service, it's necessary to enable the HealthCheck Service together with at least one of its services and at least one of the link:../notification-service/notifiers.adoc[notifiers] in the Notification Service.
...
****
HealthCheck Service Configuration is enabled?: true
