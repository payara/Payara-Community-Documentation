...
link:/documentation/core-documentation/core-documentation.adoc[Core Documentation], in
the GlassFish Server Administration Guide, under the _Run a Set of asadmin Subcommands From a File_ section.
