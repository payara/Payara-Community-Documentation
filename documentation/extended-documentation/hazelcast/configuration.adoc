...
Since 4.1.1.171 Payara Server uses its own serialiser instead of the default Hazelcast one. Setting a global serialiser will not override it.
This was created to avoid a bug causing ClassNotFoundExceptions.
